...
//    POPUP_STORE_VIEW_DETAIL
    ...
    POPUP_GOODS_REGISTER_FAIL_IMG_FORMAT(false, 4001, "상품 이미지 파일 형식이 맞지 않습니다."),
    POPUP_GOODS_REGISTER_FAIL_NAME_EMPTY(false, 4002, "상품명을 입력해주세요"),
    POPUP_GOODS_REGISTER_FAIL_PRICE_EMPTY(false, 4003, "상품 가격을 입력해주세요"),
    POPUP_GOODS_REGISTER_FAIL_AMOUNT_EMPTY(false, 4004, "등록할 상품의 수량을 입력해주세요"),
    // 팝업 굿즈 조회(R)
...
//            BOARD_WRITE_FAIL_TITLE_EMPTY
//    BOARD_WRITE_FAIL_CONTENT_EMPTY
//                    BOARD_
//    // 댓글
//    COMMENT
